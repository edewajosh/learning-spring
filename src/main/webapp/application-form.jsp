		...
		<div class="col-4">
			<ul class="list-group">
				<li
					...
					Leave Days Carried Forward <span
					class="badge badge-info badge-pill">${record.daysCarriedForward }</span>
				</li>
				<li
					class="list-group-item d-flex justify-content-between align-items-center">
					Total Leave Days <span class="badge badge-success badge-pill">${record.currentYearLeaveDays }</span>
				</li>
				<li
					class="list-group-item d-flex justify-content-between align-items-center">
					Remaining Leave Days <span class="badge badge-danger badge-pill">${record.remainingLeaveDays }</span>
				</li>
			</ul>
		</div>
